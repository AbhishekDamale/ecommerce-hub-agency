...
type FounderProfile = { name: string; initials: string; role: string; email?: string; phone?: string; education: string; focus: string; color: "coral" | "blue" | "navy"; photo: string };
...
const founderProfiles: FounderProfile[] = [
  ...
  { name: "Himanshu Kharwade", initials: "HK", role: "Engineering Student · Social Media & Design Head", education: "Engineering Student · AIDS Department", focus: "Social media coordination, visual design, and helping the studio show up with clarity and consistency.", color: "navy", photo: HIMANSHU_PHOTO },
];
