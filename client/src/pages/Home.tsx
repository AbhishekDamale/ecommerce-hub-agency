  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section id="about" className="section founders-section"><span className="section-stamp founders-stamp">Ledger / 04</span><div className="founders-aside"><p className="eyebrow"><span>04</span> The people behind it</p><div className="founders-word">two<br /><em>minds</em><br />moving<br />one idea.</div><p className="founders-note">e_commerce.hub is a two-person agency built around close collaboration, useful questions, and work that keeps its feet on the ground.</p></div><div className="founder-cards"><article className="founder-card founder-card-coral reveal-on-scroll" role="button" tabIndex={0} onClick={() => setFounderModal(founderProfiles[0])} onKeyDown={(event) => { if (event.key === "Enter" || event.key === " ") { event.preventDefault(); setFounderModal(founderProfiles[0]); } }}><div className="founder-card-top"><span>01 / Founder</span><ArrowUpRight size={18} /></div><div className="founder-photo founder-photo-abhishek"><img src={ABHISHEK_PHOTO} alt="Abhishek Damale" /><span>AD / 01</span></div><div className="founder-card-bottom"><h3>Abhishek<br />Damale</h3><p>Strategy, positioning, and the question that makes the whole thing click.</p></div></article><article className="founder-card founder-card-blue reveal-on-scroll" role="button" tabIndex={0} onClick={() => setFounderModal(founderProfiles[1])} onKeyDown={(event) => { if (event.key === "Enter" || event.key === " ") { event.preventDefault(); setFounderModal(founderProfiles[1]); } }}><div className="founder-card-top"><span>02 / Founder</span><ArrowUpRight size={18} /></div><div className="founder-photo founder-photo-yash"><img src={YASH_PHOTO} alt="Yash Mete" /><span>YM / 02</span></div><div className="founder-card-bottom"><h3>Yash<br />Mete</h3><p>Digital systems, social momentum, and the details people remember.</p></div></article></div></section>
