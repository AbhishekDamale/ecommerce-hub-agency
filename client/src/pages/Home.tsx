...
type FounderProfile = { name: string; initials: string; role: string; email: string; phone: string; education: string; focus: string; color: "coral" | "blue"; photo: string };

const founderProfiles: FounderProfile[] = [
  { name: "Abhishek Damale", initials: "AD", role: "Co-founder + Developer", email: "abhishekdamale67@gmail.com", phone: "9112658707", education: "3rd Year Engineering Student · Computer Science · Savitribai Phule Pune University", focus: "Web development, digital systems, and turning early ideas into useful online experiences.", color: "coral", photo: ABHISHEK_PHOTO },
  { name: "Yash Mete", initials: "YM", role: "Co-founder + Developer", email: "yashmete266@gmail.com", phone: "8378976036", education: "3rd Year Engineering Student · Computer Science · Savitribai Phule Pune University", focus: "Web development, social growth, and the details that make a digital presence feel clear and memorable.", color: "blue", photo: YASH_PHOTO },
];
