    ...
    <div className="site-shell">
      ...
      <header className={`site-header ${scrolled ? "is-scrolled" : ""}`}>
        ...
        <nav className={`site-nav ${menuOpen ? "is-open" : ""}`} aria-label="Primary navigation">
          <button className={activeSection === "services" ? "is-active" : ""} type="button" onClick={() => handleNav("services")}>Services</button><button className={activeSection === "work" ? "is-active" : ""} type="button" onClick={() => handleNav("work")}>Work</button><button className={activeSection === "about" ? "is-active" : ""} type="button" onClick={() => handleNav("about")}>About</button><button className={activeSection === "contact" ? "is-active" : ""} type="button" onClick={() => handleNav("contact")}>Contact</button><Link className="nav-explore-link" href="/explore">Explore <ArrowUpRight size={13} /></Link>
        </nav>
      ...
      <main id="top">
        <section className="hero-section" aria-labelledby="hero-title">
          ...
          <div className="hero-copy reveal-up"><p className="eyebrow"><span className="eyebrow-dot" /> Growth partners for the next move</p><h1 id="hero-title">Make your next <em>market</em> feel closer.</h1><p className="hero-lede">e_commerce.hub helps businesses and startups move from local attention to global demand — through clear marketing, social growth, and websites built to convert.</p><div className="hero-capabilities"><span><b>01</b> Fast moves</span><span><b>02</b> Clear thinking</span><span><b>03</b> Built to grow</span></div><div className="hero-actions"><Link className="button button-coral" href="/work">Past work <ArrowUpRight size={17} /></Link><Link className="button button-paper" href="/services">Services <ArrowDownRight size={16} /></Link><Link className="button button-outline-light" href="/packages">Packages <ArrowUpRight size={16} /></Link></div><div className="hero-footnote"><span className="hero-rule" /><span>Founded by Abhishek Damale + Yash Mete</span></div></div>
        ...
        <section id="signal" className="signal-section" aria-labelledby="signal-title"><div className="signal-badge"><Sparkles size={16} /> the e_commerce.hub method</div><span className="section-stamp signal-stamp">Ledger / 02</span><div className="signal-heading"><p className="eyebrow eyebrow-light"><span>02</span> How we work</p><h2 id="signal-title">From <em>signal</em><br />to momentum.</h2></div><div className="signal-steps">{steps.map((step) => <article className="signal-step reveal-on-scroll" key={step.index}><div className="step-top"><span>{step.index}</span><ArrowUpRight size={17} /></div><h3>{step.title}</h3><p>{step.copy}</p></article>)}</div><div className="signal-footer"><span>Small team. Close attention.</span><span>Made for businesses with somewhere to go <ArrowUpRight size={15} /></span></div></section>
        ...
        <section id="about" className="section founders-section"><span className="section-stamp founders-stamp">Ledger / 04</span><div className="founders-aside"><p className="eyebrow"><span>04</span> The people behind it</p><div className="founders-word">two<br /><em>minds</em><br />moving<br />one idea.</div><p className="founders-note">e_commerce.hub is a two-person agency built around close collaboration, useful questions, and work that keeps its feet on the ground.</p></div><div id="team" className="founder-cards"><article className="founder-card founder-card-coral reveal-on-scroll" role="button" tabIndex={0} onClick={() => setFounderModal(founderProfiles[0])} onKeyDown={(event) => { if (event.key === "Enter" || event.key === " ") { event.preventDefault(); setFounderModal(founderProfiles[0]); } }}><div className="founder-card-top"><span>01 / Founder</span><ArrowUpRight size={18} /></div><div className="founder-photo founder-photo-abhishek"><img loading="lazy" src={ABHISHEK_PHOTO} alt="Abhishek Damale" /><span>AD / 01</span></div><div className="founder-card-bottom"><h3>Abhishek<br />Damale</h3><p>Strategy, positioning, and the question that makes the whole thing click.</p></div></article><article className="founder-card founder-card-blue reveal-on-scroll" role="button" tabIndex={0} onClick={() => setFounderModal(founderProfiles[1])} onKeyDown={(event) => { if (event.key === "Enter" || event.key === " ") { event.preventDefault(); setFounderModal(founderProfiles[1]); } }}><div className="founder-card-top"><span>02 / Founder</span><ArrowUpRight size={18} /></div><div className="founder-photo founder-photo-yash"><img loading="lazy" src={YASH_PHOTO} alt="Yash Mete" /><span>YM / 02</span></div><div className="founder-card-bottom"><h3>Yash<br />Mete</h3><p>Digital systems, social momentum, and the details people remember.</p></div></article></div></section>
