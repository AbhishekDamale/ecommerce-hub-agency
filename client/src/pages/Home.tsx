  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section id="about" className="section founders-section"><span className="section-stamp founders-stamp">Ledger / 04</span><div className="founders-aside"><p className="eyebrow"><span>04</span> The people behind it</p><div className="founders-word">two<br /><em>minds</em><br />moving<br />one idea.</div><p className="founders-note">e_commerce.hub is a two-person agency built around close collaboration, useful questions, and work that keeps its feet on the ground.</p></div><div className="founder-cards"><article className="founder-card founder-card-coral reveal-on-scroll"><div className="founder-card-top"><span>01 / Founder</span><ArrowUpRight size={18} /></div><div className="founder-initials">AD</div><div className="founder-card-bottom"><h3>Abhishek<br />Damale</h3><p>Strategy, positioning, and the question that makes the whole thing click.</p></div></article><article className="founder-card founder-card-blue reveal-on-scroll"><div className="founder-card-top"><span>02 / Founder</span><ArrowUpRight size={18} /></div><div className="founder-initials">YM</div><div className="founder-card-bottom"><h3>Yash<br />Mete</h3><p>Digital systems, social momentum, and the details people remember.</p></div></article></div></section>

        <section id="contact" className="contact-section"><span className="section-stamp contact-stamp">Ledger / 05</span><div className="contact-grid-line" aria-hidden="true" /><div className="contact-copy"><p className="eyebrow"><span>05</span> Your next move</p><h2>Ready to move from <em>local</em> to global?</h2><p>Tell us what you are building, where it is stuck, or where you want it to go. We will come back with a useful first thought.</p><a className="button button-navy" href="mailto:hello@ecommercehub.agency">hello@ecommercehub.agency <ArrowUpRight size={17} /></a></div><div className="contact-mark" aria-hidden="true"><div className="contact-symbol"><img src={`${STORAGE}ecommerce-hub-symbol_d92f1230.png`} alt="" /></div><Globe2 size={76} strokeWidth={1.1} /><span>local / global</span></div></section>
      </main>
